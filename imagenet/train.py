...
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet50_kcla',
                    choices=model_names,
                    help='model architecture: ' +
                        ' | '.join(model_names) +
                        ' (default: resnet50_kcla)')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=True, sampler=train_sampler,prefetch_factor=16)
